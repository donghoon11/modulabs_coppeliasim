...
class youBotPP:
    ...
    def follow_path(self, path):
        if path:
            ...
            while True:
                current_pos = self.sim.getObjectPosition(self.refHandle, -1)
                print(f'current_position = {current_pos}')
    ...
    def run_step(self, count):
        while self.run_flag:
            ...
            print(f'robot_position : {self.sim.getObjectPosition(self.refHandle)}')
